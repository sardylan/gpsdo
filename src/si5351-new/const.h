#ifndef GPSDO__SI5351__CONST__H
#define GPSDO__SI5351__CONST__H
...
typedef int si5351_exit_type;
#define si5351_exit_success() return EXIT_SUCCESS;
#define si5351_exit_failure() return EXIT_FAILURE;

typedef uint64_t si5351_frequency;
typedef int64_t si5351_frequency_correction;
